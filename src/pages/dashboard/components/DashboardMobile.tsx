...
export function DashboardMobile({
    ...
    return (
        <div className="flex flex-col gap-6 animate-in fade-in duration-500">
            ...
            <div className={cn(
                "flex flex-col gap-6 pb-24 transition-all duration-300",
                isLocked ? "blur-md pointer-events-none select-none opacity-50 grayscale-[0.2]" : ""
            )}>
                {/* Summary Cards */}
            ...
            {/* The Focus Overlay */}
            {shouldShowOnboarding && <DashboardOnboarding isMobile isFirstTimeUser={isFirstTimeUser} />}
        </div>
    );
}
